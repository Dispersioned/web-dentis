...
var Body = (0,_mui_material__WEBPACK_IMPORTED_MODULE_1__["default"])('div')(_templateObject || (_templateObject = (0,_babel_runtime_helpers_esm_taggedTemplateLiteralLoose__WEBPACK_IMPORTED_MODULE_0__["default"])(["\n  display: block;\n  width: 50px;\n  height: 50px;\n  position: relative;\n  cursor: pointer;\n\n  &::before,\n  &::after,\n  span {\n    position: absolute;\n    display: block;\n    width: 35px;\n    height: 2px;\n    background-color: ", ";\n    border-radius: 5px;\n    left: 50%;\n  }\n\n  &::before,\n  &::after {\n    content: '';\n  }\n\n  &::before {\n    top: 20%;\n    transform: ", ";\n  }\n\n  &::after {\n    bottom: 20%;\n    transform: translate(-50%, -50%);\n  }\n\n  span {\n    left: 50%;\n    top: 50%;\n    transform: translate(-50%, -50%);\n  }\n"])), function (props) {
  ...
  return props.active ? '' : 'translate(-50%, 50%)';
});
...
/******/ !function() {
/******/ 	__webpack_require__.h = function() { return "d42dad7d4a284d351248"; }
/******/ }();
/******/ 
/******/ }
);
//# sourceMappingURL=cms.0b5f2a4075fe2ccb2e1e.hot-update.js.map